        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Surname = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: ""),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Trips", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Trips_Promoters_PromoterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BudgetSize = table.Column<double>(type: "float", nullable: false),
                    ShareHoldersCount = table.Column<int>(type: "int", nullable: false),
                    BankAccunt = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
